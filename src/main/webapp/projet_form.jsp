            ...
            <form action="/projet/edit" method="post">
                ...
                <form action="/projet/new" method="post">
                    ...
                    <fieldset class="form-group">
                        ...
                        <input type="text" value="${projet.nom}" class="form-control" name="nom" required>
                    </fieldset>
                    <fieldset class="form-group">
                        <label>Description</label>
                        <textarea class="form-control" name="description" rows="3" required>${projet.description}</textarea>
                    </fieldset>
                    <fieldset class="form-group">
                    ...
                    <fieldset class="form-group">
                        <label>Budget (€)</label>
                        <input type="number" value="${projet.budjet}" class="form-control" name="budjet" min="0" required>
                    </fieldset>
