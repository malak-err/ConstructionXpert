...
<nav>
    <div class="sidebar" style="display: flex;gap: 59px ; justify-content: center ; color: aliceblue">
...
<div class="container">
    ...
    <div id="projects" class="page">
        <div class="page-header">
            <h1 class="page-title"> Listes des taches </h1>
            <a href="<%=request.getContextPath()%>/taches_form.jsp" class="add-button" onclick="openModal('taches-modal'); " style="background-color: #80b4dc">
                + Ajouter une tache
            </a>    </div>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="tache" items="${taches}">
                ...
                <tr>
                    ...
                    <td><a href="/taches/edit-form?id=<c:out value='${tache.id}' />" ><i class="fa-solid fa-pen-to-square"></i></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a   href="/taches/delete?id=<c:out value='${tache.id}' /> " data-toggle="modal" data-target="#modal"><i class="fa-solid fa-trash"></i></a> </td>
                </tr>
